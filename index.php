...
<body>
    <div class="login-container d-flex flex-column">
        ...
        <form method="POST" id="login-form" novalidate>
            <div class="text-center"><span class="highlighted-char">G</span>UIDANCE <span class="highlighted-char">E</span>FFECTIVE <span class="highlighted-char">M</span>ONITORING <span class="highlighted-char">S</span>YSTEM</div>
            <span id="error"></span>
            <div class="mb-3">
