...
<body>
    ...
    <div class="container col-10 h-100 z-2 position-fixed end-0 d-flex flex-column py-3 bg-light">
        ...
        <form class="container h-100 overflow-y-auto py-2 px-2 d-flex align-items-center flex-column" id="add-std-form">

            <div class="input-group flex-nowrap my-2 w-100 ">
                <span class="input-group-text" id="addon-wrapping">LRN</span>
                <input type="number" class="form-control" name="lrn" placeholder="Learner Reference Number" aria-label="Learner Reference Number" aria-describedby="addon-wrapping">
            </div>
            ...
            <div class="input-group flex-nowrap my-2 w-100">
                ...
                <input type="text" class="form-control" name="last_name" placeholder="Last Name" aria-label="Lastname" aria-describedby="addon-wrapping">
            </div>

            <div class="input-group flex-nowrap my-2 w-100">
                <span class="input-group-text" id="addon-wrapping">first name</span>
                <input type="text" class="form-control" name="first_name" placeholder="First Name" aria-label="Firstname" aria-describedby="addon-wrapping">
            </div>
            ...
            <div class="input-group flex-nowrap my-2 w-100">
                ...
                <input type="date" class="form-control" name="bdate" placeholder="birth date" aria-label="Birth Date" aria-describedby="addon-wrapping">
            </div>
            ...
            <div class="input-group flex-nowrap my-2 w-100">
                ...
                <input type="text" class="form-control" name="phoneNumber" placeholder="Phone Number" aria-label="Phone Number" aria-describedby="addon-wrapping">
            </div>
            ...
            <div class="input-group flex-nowrap my-2 w-100">
                ...
                <input type="text" class="form-control" name="current_address" placeholder="Current Address" aria-label="Current Address" aria-describedby="addon-wrapping">
            </div>
            ...
            <div class="input-group flex-nowrap my-2 w-100">
                ...
                <input type="text" class="form-control" name="nationality" placeholder="Nationality" aria-label="Nationality" aria-describedby="addon-wrapping">
            </div>
